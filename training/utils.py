...
# STEP 2 - Visualize and balance the data
...
# STEP 3 - Prepare for data processing
...
def loadData(path, data):
    ...
    for i in range(len(data)):
        ...
        filepath = os.path.join(path, indexed_data[0])
...
# imgRe, st = augmentImage('drivingData/IMG0/Image_16187651324266.jpg', 0)
# plt.imshow(imgRe)
# plt.show()


# STEP 6 - Preprocessing (Nvidia recomended)
...
#imgRe = preProcessing(mpimg.imread('drivingData/IMG0/Image_16187651324266.jpg'))
# plt.imshow(imgRe)
# splt.show()
